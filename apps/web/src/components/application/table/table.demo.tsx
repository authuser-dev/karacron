...
import customers from '@application/table/customers.json';
import invoices from '@application/table/invoices.json';
import { Table, TableCard } from '@application/table/table';
import teamMembers from '@application/table/team-members.json';
import uploadedFiles from '@application/table/uploaded-files.json';
								...
								<div className="flex gap-1">
									{item.teams.slice(0, 3).map((team) => (
										<Badge
											key={team.name}
											color={
												team.color as BadgeColor<BadgeTypes>
											}
											size="sm"
										>
											{team.name}
			...
			<div className="flex items-center justify-center overflow-hidden px-8 py-20">
				<EmptyState size="sm">
					...
					<EmptyState.Content>
						...
						<EmptyState.Description>
							Connect the tools you use every day to automate
							workflows and keep your data in sync.
						</EmptyState.Description>
					</EmptyState.Content>
