...
import * as Paginations from '@application/pagination/pagination';
import { PaginationDot as PaginationDotComponent } from '@application/pagination/pagination-dot';
import { PaginationLine as PaginationLineComponent } from '@application/pagination/pagination-line';
...
export const PaginationCardMinimalRightAligned = () => {
	...
	return (
		<Paginations.PaginationCardMinimal
			align="right"
			page={currentPage}
			onPageChange={setCurrentPage}
		/>
