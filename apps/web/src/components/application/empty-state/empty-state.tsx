...
import { FeaturedIcon as FeaturedIconbase } from '@foundation/featured-icon/featured-icon';
import type { BackgroundPatternProps } from '@shared-asset//background-patterns';
import { BackgroundPattern } from '@shared-asset//background-patterns';
import { Illustration as Illustrations } from '@shared-asset//illustrations';
...
const AvatarRow = ({ avatars = [], children, ...props }: AvatarRowProps) => {
	...
	return (
		<div
			...
			style={{
				maskImage:
					'radial-gradient(circle, black 5%, transparent 105%)',
				WebkitMaskImage:
					'radial-gradient(circle, black 5%, transparent 105%)',
				...props.style,
			}}
