...
export const DatePickerDemo = () => (
	<DatePicker aria-label="Date picker" defaultValue={now} />
);
						...
						<>
							<div className="flex">
								...
								<div className="relative hidden min-h-0 w-50 flex-col gap-4 md:flex">
									<div className="px-5 pt-6.5 text-center text-sm font-semibold text-fg-secondary">
										Available times
									</div>
	...
	return (
		<div className="relative h-180 w-full max-w-180 [--clip-boundary:50%]">
			<div
				style={{
					clipPath:
						'polygon(0 0, var(--clip-boundary) 0, var(--clip-boundary) 100%, 0 100%)',
			...
			<div
				style={{
					clipPath:
						'polygon(var(--clip-boundary) 0, 100% 0, 100% 100%, var(--clip-boundary) 100%)',
					transitionTimingFunction:
						'cubic-bezier(0.25, 0.1, 0.25, 1)',
				}}
