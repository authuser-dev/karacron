		...
		<Dropdown.Root>
			...
			<Dropdown.Popover className="w-60">
				<Dropdown.Menu selectionMode="none">
					<Dropdown.Section>
						<Dropdown.Item icon={ArrowNarrowLeft}>
							Back
						</Dropdown.Item>
						<Dropdown.Item icon={ArrowNarrowRight}>
							Forward
						</Dropdown.Item>
					...
					>
						<Dropdown.Item id="show-bookmarks">
							Show bookmarks
						</Dropdown.Item>
						<Dropdown.Item id="show-urls">
							Show full URLs
						</Dropdown.Item>
					</Dropdown.Section>
