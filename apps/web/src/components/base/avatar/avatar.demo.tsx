...
import {
	AvatarAddButton,
	AvatarCompanyIcon,
} from '@base/avatar/base-components';
		...
		<div className="flex gap-2">
			<div className="flex -space-x-3">
				...
				<Avatar
					...
					className="ring-[1.5px] ring-bg-primary"
					placeholder={
						<span className="flex items-center justify-center text-md font-semibold text-quaternary">
							+5
						</span>
					}
				/>
...
export const Default = () => (
	<div className="flex flex-col gap-4">
		...
		<div className="flex items-start gap-8">
			<a
				href="#"
				className="group relative inline-flex focus:outline-hidden"
			>
				<Avatar
					size="xs"
					src="https://www.untitledui.com/images/avatars/olivia-rhye?fm=webp&q=80"
