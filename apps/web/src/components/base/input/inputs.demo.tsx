...
import { Input, InputBase, TextField } from '@base/input/input';
import { InputFile } from '@base/input/input-file';
...
import { InputTagsOuter } from '@base/input/input-tags-outer';
		...
		<InputGroup
			...
			trailingAddon={
				<Button
					...
					onClick={() => copy(value || 'www.untitledui.com')}
				>
					Copy
				</Button>
			}
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue1 || 'www.untitledui.com',
									'input-1',
								)
							}
						>
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue2 || 'www.untitledui.com',
									'input-2',
								)
							}
						>
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue3 || 'www.untitledui.com',
									'input-3',
								)
							}
						>
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue4 || 'www.untitledui.com',
									'input-4',
								)
							}
						>
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue5 || 'www.untitledui.com',
									'input-5',
								)
							}
						>
				...
				<InputGroup
					...
					trailingAddon={
						<Button
							...
							onClick={() =>
								copy(
									inputValue6 || 'www.untitledui.com',
									'input-6',
								)
							}
						>
